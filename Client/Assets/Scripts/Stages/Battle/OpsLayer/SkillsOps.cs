...
public class SkillsOps : StageOpsLayer
{
    ...
    Action moveWorrior = null;
    Warrior warrior;

    // 显示炮塔释放范围
    public void ShowSkillAttackRange(float x, float y, IWithRange skill, Action< int, int> onSelPos, Action moveWorrior)
    {
        this.Skill = skill;
        this.onSelPos = onSelPos;
        this.moveWorrior = moveWorrior;
